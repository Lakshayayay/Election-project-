    ...
    <div className="min-h-screen bg-[#f3f4f6]">
        ...
        <div className="border-b border-white/20 py-3">
          <div className="max-w-[1400px] mx-auto px-4 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 text-sm">Secure Official Access</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-10">
        <div className="bg-white border border-gray-300 shadow-sm p-8">
          ...
          <p className="text-gray-600 mb-6">Enter your official demo credentials to continue.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-[#004a9f] text-white py-2 px-4 font-bold hover:bg-[#003d82] transition-colors"
            >
              Sign In
            </button>
          </form>
